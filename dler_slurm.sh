...
export HF_TOKEN=YOURAPIKEY

GPFS="./verl-main"
PROJECT="public_verl_1.5b_dler_bsz512"
EXPNAME="TEST"
CKPT_DIR="./1.5b_public_verl_dler/results/$PROJECT/$EXPNAME/ckpt"
RESULTS_DIR="./1.5b_public_verl_dler/results/$PROJECT/$EXPNAME/$SLURM_JOB_ID"
mkdir -p $RESULTS_DIR
mkdir -p $CKPT_DIR


# TODO: add image name
container_name="ADDRESS TO YOUR CONTAINER sqsh FILE"
