...
def compute_policy_loss_vanilla(
    ...
    # response_adv_sum = advantages.sum(dim=1)
    # num_positive = (response_adv_sum > 0).sum().item()
    # num_negative = (response_adv_sum < 0).sum().item()
    # print(f"total responses: {advantages.shape[0]}")
    # print(f"Positive responses: {num_positive}")
    # print(f"Negative responses: {num_negative}")
